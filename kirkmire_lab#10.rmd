...
#Fit Full Model#
full.lm<-lm(LifeExp~Population+Income+Illiteracy+Murder+HSGrad+Frost+Area, data=rel.state)
...
vec.press <- c(press.full, press.1, press.2, press.3, press.4,
press.5)

library(cvTools)
cv.full <- repCV(model.full, K=10, R=20, seed=723)
...
cv.vec <- c(30.45817, 29.46631, 28.13321, 28.45137, 30.13718,
31.93976)
