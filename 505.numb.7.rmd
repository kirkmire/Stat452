...
ba_total_function_A <- function(x) {
   result<-18*400*(((((x)/100)/2)^2)*3.14)
   return(result)
}

Tba_hat_A1<-sum(ba_total_function_A(A_1))
Tba_hat_A2<-sum(ba_total_function_A(A_2))
Tba_hat_A3<-sum(ba_total_function_A(A_3))
Tba_hat_A4<-sum(ba_total_function_A(A_4))
...
Tba_hat_A1_ten<-sum(ba_total_function_A(A_1[A_1>10]))
Tba_hat_A2_ten<-sum(ba_total_function_A(A_2[A_2>10]))
Tba_hat_A3_ten<-sum(ba_total_function_A(A_3[A_3>10]))
Tba_hat_A4_ten<-sum(ba_total_function_A(A_4[A_4>10]))
...
sqrt(var_ba_total_A_ten+var_ba_total_A_ten)
...
diam_A1<-sum(A_1)*400*18
diam_A2<-sum(A_2)*400*18
diam_A3<-sum(A_3)*400*18
diam_A4<-sum(A_4)*400*18

est_diam_total_A<-mean(diam_A1,diam_A2,diam_A3,diam_A4)
...
total_diam<-function(x) {
   result<-BAF*42*(sum(x/((x/200)^2)*3.14))
   return(result)
}
...
est_diam_total_all_plots_B<-mean(diam_B1,diam_B2,diam_B3,diam_B4,diam_B5)
  
est_diam_B<-est_diam_total_all_plots_B/est_tree_total_B
