...
The residual deviance decreases only slightly and the chi-squared test provides strong evidence that both of the added square coefficients are equal to zero. Therefore, it is not neccesary or advisable to add the squared terms to the model.
...
The residual deviance decreases only slightly and the chi-squared statistic provides strong evidence that the coefficients of the added pairwise interactions are equal to zero. Therefore, it is not neccesary or advisable to add the squared terms to the model.
