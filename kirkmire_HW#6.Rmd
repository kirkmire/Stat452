...
(h)
```{r}
sansAK<-summary(sansAK.lm)

#Confidence intervals for coefficients#

#Expend#
sansAK$coefficients[4]+c(-1,1)*sansAK$coefficients[4,2]*sansAK$coefficients[4,3]

#Years#
sansAK$coefficients[5]+c(-1,1)*sansAK$coefficients[5,2]*sansAK$coefficients[5,3]

#Rank#
sansAK$coefficients[6]+c(-1,1)*sansAK$coefficients[6,2]*sansAK$coefficients[6,3]
