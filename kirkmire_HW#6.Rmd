...
In contrast, there is a strong positive relationship between Rank and SAT (r=.88).  The state's average total SAT score increases as the median percentile rank of test-takers increases. 
...
The three states with the lowest SAT scores (South Carolina, Georgia and North Carolina) may be outliers.  #look into this more#
...
#Resid vs Fitted#
plot(b.sat.lm,which=c(1))

#Cooks Distance#
plot(b.sat.lm,which=c(4))

#leverage#
lev.b<-hat(model.matrix(b.sat.lm))

plot(lev.b)

#Component plus resid plots#
library(car)
cr.bplots<-crPlots(b.sat.lm)
