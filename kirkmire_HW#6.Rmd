...
Takers: 
We are 95% confident that the average state SAT score decreases between -3.39 and -58.91 for every log of the percent of high school student in the state who took the SAT given the other predictor variables included in the model are held constant.
...
Income:
We are 95% confident that the state average SAT score increases between -.11 and .34 points for every additional hundred dollars in median family income (given all other predictor variables constant)
